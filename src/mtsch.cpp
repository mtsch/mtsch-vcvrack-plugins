...
void init(rack::Plugin *p) {
    ...
    p->addModel(createModel<RationalsWidget>("mtsch", "Rationals", "Rationals", UTILITY_TAG));
    p->addModel(createModel<TriggerFishWidget>("mtsch", "TriggerFish", "TriggerFish", DELAY_TAG));
